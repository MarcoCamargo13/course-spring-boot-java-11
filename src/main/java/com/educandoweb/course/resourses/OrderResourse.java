...
@RequestMapping(value = "/orders") // dar um nome ao recurso, usar o mesmo da classe
public class OrderResourse {// disponibiliza recursos web correspondente a entidade Order
	@Autowired // para o Spring fazer a injeção de dependecia automatico
	private OrderService service; // dependencia do serviçe

	 // para indicar que é um metodo que responde o Rest do HTTP é inserido um
	@GetMapping			// Anotation
	public ResponseEntity<List<Order>> findAll() {
		// o metodo findAll recebe uma lista de Order
